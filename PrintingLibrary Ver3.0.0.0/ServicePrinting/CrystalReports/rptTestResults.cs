...
namespace Infologics.Medilogics.PrintingLibrary.ServicePrinting.CrystalReports {
    ...
    public class rptTestResults : ReportClass {
    ...
    public class CachedrptTestResults : Component, ICachedReport {
        
        public CachedrptTestResults() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptTestResults rpt = new rptTestResults();
            rpt.Site = this.Site;
            return rpt;
        }
